...
public class AddDog {
    ...
    public AddDog(String email, Integer dogID, String dogName, String breeds, String sex, boolean altered, Integer ageYears,
                      Integer ageMonths, String description, String microchipID, String microchipVendor, Date surrenderDate,
                      String surrenderPhone, boolean byAnimalControl) {
        this.dogID = dogID;

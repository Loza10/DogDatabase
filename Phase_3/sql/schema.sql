...
CREATE TABLE Director(
    email varchar(250) UNIQUE NOT NULL DEFAULT ('execdir\@burdell.com'),
    CONSTRAINT DirectorSingleton CHECK (email = 'execdir\@burdell.com')
);
...
SELECT
	...
	d.name,
	d.description,
	CONCAT(FLOOR(d.age / 12), ' yr ', d.age % 12, ' mo') AS age,
	d.sex,
	d.altered,
	d.surrender_date,
	d.surrender_phone,
	...
	b.names AS breed,
	dm.microchipID,
	a.dogID IS NOT NULL AS adopted,
	d.altered = 1 AND dm.microchipID IS NOT NULL AS adoptable
FROM
	Dog d
